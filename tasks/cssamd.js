    ...
    this.files.forEach(function(files) {      
      ...
      srcFiles.forEach(function(srcFile) {        
        ...
        try{          
          ...
          sourceModuled = modulyCSS(outputFilename, sourceCss);          
        } catch(e) {
          grunt.log.error(e);
        ...
        try{
          //outputFilename = target directory + cssFileName + .js
          outputFilename = files.dest + srcFile.substr(srcFile.lastIndexOf('/')+1) + '.js';
